...
function eval_x = quadspline_better(t,y,x)
  % the number of nodes:
  ...
  %%%% Employ SMW formula for a rank 1 modification, which allows to
  %%%% expolit the structure of the matrix
  u = zeros(n,1);
  v = zeros(n,1); 
  u(n,1) = 1;
  u(1,1) = 1;
